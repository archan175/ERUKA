    ...
    <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6">
      ...
      <div className="mb-10 text-center">
        ...
        <p className="mt-3 text-base text-muted-foreground">
          Your privacy matters to us. This policy explains how ERUKA collects, uses, and safeguards
          your personal information.
        </p>
        <p className="mt-1 text-sm text-muted-foreground/70">Last updated: 1 June 2026</p>
      </div>
